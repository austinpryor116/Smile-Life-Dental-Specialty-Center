...
export default function Periodontics() {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="h-screen relative overflow-hidden bg-black flex items-center justify-center border-b border-white/10 mb-32">
        <video 
          ref={videoRef}
        ...
        <div className="relative z-20 text-center max-w-4xl mx-auto px-8 w-full mt-20">
           <motion.span 
              ...
              className="text-accent-light uppercase tracking-[0.6em] text-[10px] font-bold mb-8 block"
           >
           ...
           >
             <Link to="/book" className="mt-8 px-14 py-6 bg-linear-to-r from-primary to-accent-light text-white font-bold uppercase tracking-[0.25em] text-[10px] hover:scale-105 transition-all duration-500 inline-flex items-center gap-4 group shadow-[0_0_30px_rgba(0,210,255,0.2)]">
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-12">
        ...
        <section className="py-32 border-b border-white/5 mb-48">
        ...
        <div className="bg-surface-container-low border border-outline-variant p-16 md:p-24 lg:p-32 mb-48">
          <span className="text-accent-light uppercase tracking-[0.6em] text-[10px] font-bold mb-8 block text-center">Surgical Directory</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 lg:gap-x-32 gap-y-16">
            {Object.values(periodontalProcedures).map((proc) => (
              <Link to={`/periodontics/${proc.slug}`} key={proc.slug} className="pb-12 border-b border-outline-variant group block">
