/**
 * Orthodontics Department Route
 * 
 * A detailed, highly styled overview of the Orthodontics department capabilities.
 * Focuses heavily on the "Sanctuary Experience" aesthetic by utilizing absolute-positioned
 * radial gradients (`bg-[radial-gradient]`) to simulate soft studio lighting behind content.
 * 
 * @module Orthodontics
 */
    ...
    <div className="pt-48 pb-48 ">
      <div className="max-w-7xl mx-auto px-8 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center mb-24 lg:mb-48">
          ...
          >
            <span className="text-accent-light uppercase tracking-[0.6em] text-[11px] md:text-[10px] font-bold mb-8 block">Specialty Care</span>
            ...
            <div className="flex flex-wrap gap-6 mt-4">
              <Link to="/book" className="px-6 py-4 md:px-10 md:py-5 bg-linear-to-r from-primary to-accent-light text-white font-bold uppercase tracking-[0.2em] text-[11px] md:text-[10px] hover:scale-[1.02] transition-all duration-500 inline-flex items-center gap-3 group shadow-[0_0_40px_rgba(0,210,255,0.3)] hover:shadow-[0_0_80px_rgba(0,210,255,0.6)]">
                Local Consult <ArrowRight size={14} className="group-hover:translate-x-2 transition-transform duration-300" />
              </Link>
              <a href="https://smilelifebraces.com/corpus-christi/" target="_blank" rel="noopener noreferrer" className="px-6 py-4 md:px-10 md:py-5 border border-accent-light text-accent-light font-bold uppercase tracking-[0.2em] text-[11px] md:text-[10px] hover:bg-accent-light hover:text-black transition-all duration-500 inline-flex items-center gap-3 group">
        ...
        <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary/10 via-primary/5 to-transparent p-8 md:p-24 lg:p-32 rounded-[2rem] lg:rounded-[3rem] mb-24 lg:mb-48">
          <span className="text-accent-light uppercase tracking-[0.6em] text-[11px] md:text-[10px] font-bold mb-8 block text-center">Treatment Options</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 lg:gap-32">
            <div className="space-y-16">
              <div className="pb-12 lg:pb-16 border-b border-white/5 group">
            ...
            <div className="space-y-16">
              ...
              <div className="pb-16 border-b border-white/5 group">
        ...
        <div className="mt-24 lg:mt-40 text-center py-16 lg:py-24 border-t border-white/5">
          <span className="text-accent-light uppercase tracking-[0.6em] text-[11px] md:text-[10px] font-bold mb-8 block text-center">Comprehensive Care</span>
          ...
          <a href="https://smilelifebraces.com/corpus-christi/" target="_blank" rel="noopener noreferrer" className="px-8 py-5 md:px-14 md:py-6 bg-linear-to-r from-[#0056B3] to-accent-light text-white font-bold uppercase tracking-[0.25em] text-[11px] md:text-[10px] hover:scale-[1.02] transition-all duration-500 inline-flex items-center gap-4 group shadow-[0_0_40px_rgba(0,210,255,0.3)] hover:shadow-[0_0_80px_rgba(0,210,255,0.6)]">
