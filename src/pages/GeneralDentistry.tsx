    ...
    <div className="pt-48 pb-48 bg-black">
      <div className="max-w-7xl mx-auto px-8 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-32 items-center mb-48">
          ...
          >
            <span className="text-accent-light uppercase tracking-[0.6em] text-[10px] font-bold mb-8 block">Essential Care</span>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-12 -right-12 bg-surface-container-low border border-outline-variant p-12 hidden md:block shadow-2xl">
              <Smile className="text-accent-light mb-6" size={32} strokeWidth={1} />
              <p className="font-headline italic text-3xl mb-2 tracking-tighter">Preventive Focus</p>
              <p className="text-[10px] uppercase tracking-[0.3em] text-accent-light font-bold opacity-60">Lifelong Oral Health</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-surface-container-low border border-outline-variant p-16 md:p-24 lg:p-32">
          <span className="text-accent-light uppercase tracking-[0.6em] text-[10px] font-bold mb-8 block text-center">Comprehensive Solutions</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
            {[
              ...
              <div key={i} className="p-10 border border-outline-variant bg-surface-container-high group hover:border-accent-light/30 transition-all duration-500">
